...
public class SplashActivity extends Activity implements SplashADListener {
    ...
    private BayesSplash bayesSplash;
...
//        skipView = (TextView) findViewById(R.id.skip_view);
        ...
        skipView.setText("HELLO WORLD");
        RelativeLayout.LayoutParams rLayoutParams = new RelativeLayout.LayoutParams(100, 50);
        rLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        rLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        container.addView(skipView,rLayoutParams);
        ...
        if(result>2) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                fetchSplashAD(this, container, skipView, "1101152570", "8863364436303842593", this, 0);
            }
        }else
        {
            //支持图片和视频的广告位
            //          bayesSplash = new BayesSplash(this,"10000497","100224","bf113b655757ba142ce2417b1349bffd");
            //图片广告位
            bayesSplash = new BayesSplash(this,"10000559","100255","757d5119466abe3d771a211cc1278df7");
            ...
            container.addView(bayesSplash,rbl);
            bayesSplash.setListener(new BayesSplashListener() {
                @Override
